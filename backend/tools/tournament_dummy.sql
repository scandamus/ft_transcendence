...
VALUES
('ちゃんま大戦争', '2024-07-21 10:00:00', '2024-07-21 10:00:00', 'upcoming', 1, 16, NULL, NULL, NULL, ''),
('関ヶ原', '2024-07-18 22:30:00', '2024-07-18 22:30:00', 'upcoming', 1, 16, NULL, NULL, NULL, ''),
('ちゃんま大戦争2', '2024-07-14 10:00:00', '2024-07-14 10:00:00', 'finished', 2, 16,
...
('staticTournament', '2024-07-14 10:00:00', '2024-07-14 10:00:00', 'finished', 2, 16,
...
VALUES
((SELECT id FROM game_tournament WHERE name = 'ちゃんま大戦争2'),
 (SELECT id FROM players_player WHERE user_id = (SELECT id FROM auth_user WHERE username = 'testplayer55')),
 'ニックネーム55555'),
((SELECT id FROM game_tournament WHERE name = 'ちゃんま大戦争2'),
 (SELECT id FROM players_player WHERE user_id = (SELECT id FROM auth_user WHERE username = 'testplayer0')),
