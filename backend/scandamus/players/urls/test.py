...
from ..views import LoginView, UserInfoView, LogoutView, RegisterView, DeleteUserView, ValidateView, AvatarUploadView, MatchLogView, RecommendedView, UserLevelView, LangUpdateView
