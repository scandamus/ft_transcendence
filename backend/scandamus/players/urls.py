...
from .views import LoginView, UserInfoView, LogoutView, RegisterView, DeleteUserView, ValidateView, UserListView, FriendListView, FriendRequestListView, AvatarUploadView
