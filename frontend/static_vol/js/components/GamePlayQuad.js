        ...
        return `
           <div class='playBoardWrap playBoardWrap-quad'>
                <ul class='listPlayerActiveMatch listPlayerActiveMatch-quad-first-half'>
                    ...
                    <li class="listPlayerActiveMatch_item listPlayerActiveMatch_item-player2"><img src="${this.avatar3}" alt="" width="50" height="50"><span>${this.player3}</span></li>
                </ul>
                <ul class='listPlayerActiveMatch listPlayerActiveMatch-quad-second-half'>
                    <li class="listPlayerActiveMatch_item listPlayerActiveMatch_item-player3"><img src="${this.avatar2}" alt="" width="50" height="50"><span>${this.player2}</span></li>
